package dev.shermende.spring.support.aop;

import dev.shermende.spring.support.component.annotation.InterceptResult;
...
public class AopInterceptResult {
    ...
    @AfterReturning(pointcut = "@annotation(dev.shermende.spring.support.component.annotation.InterceptResult)", returning = "result")
