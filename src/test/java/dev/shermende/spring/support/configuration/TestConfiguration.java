...
@ComponentScan("dev.shermende.spring.support")
@Configuration
@EnableInterceptor
@EnableAspectJAutoProxy(proxyTargetClass = true)
@EnableTransactionManagement
@EnableJpaRepositories(basePackages = "dev.shermende.spring.support.db.repository")
public class TestConfiguration {
    private static final String ENTITIES = "dev.shermende.spring.support.db.entity";
