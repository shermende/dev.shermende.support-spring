...
import dev.shermende.spring.intercept.component.annotation.InterceptResult;
...
public class AopInterceptResult {
    ...
    @AfterReturning(pointcut = "@annotation(dev.shermende.spring.intercept.component.annotation.InterceptResult)", returning = "result")
